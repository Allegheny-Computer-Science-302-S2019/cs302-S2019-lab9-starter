...
# cs302-S2019-lab9-starter

Designed for use with [GitHub Classroom](https://classroom.github.com/), this
repository contains the starter for Lab 9 in Computer Science 302. Since
...
with correctly connecting the provided HTML and JavaScript files, you will
extend the JavaScript to display details about five new countries. Moreover,
each student will use an existing GitHub repository to add all of the remaining
country flags to their web site. Additionally, you will continue to practice
using the [HTMLHint](http://htmlhint.com/) static analysis code tool that can
check HTML files for potential errors. The source code in the `index.html` file
must also pass additional tests set by the [GatorGrader
...
links it to the JavaScript. More details about the GatorGrader checks are
...
existence of `index.html` in the `src/www/` directory, the existence of
`country.js` in the `src/www/js/` directory, and a screenshot in the `images/`
directory. GatorGrader will also check to ensure that your files do not contain
any markers indicating that your files are not yet complete. Finally,
GatorGrader will check to ensure that you have furnished an answer for each of
the technical questions in the `reflection.md` file in the `writing` directory.
You can learn about the other checks that GatorGrader performs by typing
...
```
git remote add download git@github.com:Allegheny-Computer-Science-302-S2019/cs302-S2019-lab9-starter.git
```
...
you can go to the [Computer Science 302 Lab 9
Starter](https://github.com/Allegheny-Computer-Science-302-S2019/cs302-S2019-lab9-starter)
